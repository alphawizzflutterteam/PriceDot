...
class _CouponDiscountScreenState extends State<CouponDiscountScreen> {
  ...
  Future<void> getPromo() async {
    try {
      ...
      var request = http.Request(
          'GET', Uri.parse('${baseUrl}/Apicontroller/get_promo_list'));
  ...
  List<bool> apply = [];
  Future<void> applyPromo({required String promoCode,required int index}) async {
    try {
      setState(() {
        apply[index]=true;
      });
      ...
      var request = http.MultipartRequest(
          'POST', Uri.parse('${baseUrl}/Apicontroller/validate_promo_code'));
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          DateFormat('dd/MM/yyyy').format(
                                              DateTime.parse(promoCodes[index]
                                                  .validTill
                                                  .toString())),
                                          style: TextStyle(
                                              fontSize: 14,
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child:apply[index]?Center(child: SizedBox(
                                            height: 25,
                                            width: 25,
