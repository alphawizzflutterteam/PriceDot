  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          ...
          body: getResultDetailsModel == null
              ? Center(
                  ...
                  child: Padding(
                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                          itemCount: getResultDetailsModel!
                              .data!.lotteries![0].winners!.length,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                                "Winning Position : ${getResultDetailsModel!.data!.lotteries![0].winners![i].winningPosition}",
                                                style: TextStyle(
                                            ...
                                            Text(
                                                "Winner Price : ₹${getResultDetailsModel!.data!.lotteries![0].winners![i].winnerPrice}",
                                                style: TextStyle(
                                                    color: AppColors.fntClr,
                                                    fontWeight:
                                                        FontWeight.w500)),
                                            ...
                                            Text(
                                              "Winner Name : ${getResultDetailsModel!.data!.lotteries![0].winners![i].userName}",
                                              style: TextStyle(
                                                  color: AppColors.fntClr,
                                        ...
                                        Container(
                                          ...
                                          child: Card(
                                            ...
                                            child: Center(
                                                child: Text(
                                                    "${getResultDetailsModel!.data!.lotteries![0].winners![i].lotteryNo}")),
                                          ),
                                        ),
                                      ],
                                    )
